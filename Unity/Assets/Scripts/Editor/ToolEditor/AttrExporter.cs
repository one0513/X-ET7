...
namespace ET
{
    ...
    {
        private const string ClassDir = "..//Unity/Assets/Scripts/Codes/Model/Share/Module/Numeric/NumericType.cs";
        
        private const string excelDir = "../Unity/Assets/Config/Excel/Datas";
        public class Info
        {
            public string Key;
            public string Id;
