...
namespace ET
{
    [Invoke(TimerInvokeType.MoveAndSpellSkill)]
    [FriendOf(typeof(SkillAbility))]
    [FriendOf(typeof(MoveAndSpellComponent))]
    public class MoveAndSpellSkill: ATimer<MoveAndSpellComponent>
    {
        protected override void Run(MoveAndSpellComponent self)
        {
            try
            {
    ...
    {
        protected override void Destroy(MoveAndSpellComponent self)
        {
            if (self.Skill != null)
            {
                self.Skill = null;
        ...
        public static void SpellWithTarget(this MoveAndSpellComponent self, SkillAbility spellSkill, CombatUnitComponent targetEntity)
        {
                ...
                spellSkill.SkillConfig.PreviewRange[0])
            {
                ...
                if (self.Skill == null)
                {
                    ...
                    self.TimerId = TimerComponent.Instance.NewFrameTimer(TimerInvokeType.MoveAndSpellSkill, self);
                }
...
#else
            spellSkill.UseSkill(float3.zero,targetEntity.Id);
#endif
        }
        /// <summary>
        /// 释放对点技能
