...
namespace ET
{
    ...
    public class OnSkillTrigger_OnSkillTrigger : AEvent<Scene,EventType.OnSkillTrigger>
    {
        
        protected override async ETTask Run(Scene scene, OnSkillTrigger args)
        {
            ...
            List<int> cost,SkillConfig config,AOIUnitComponent skill = null)
        {
            ...
            // Log.Info("触发"+type.ToString()+to.Position+" Dis: "+float3.Distance(to.Position,from.Position));
            int formulaId = 0;//公式
